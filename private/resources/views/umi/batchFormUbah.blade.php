@extends('deskapp.app')
@section('tittle', ' Edit Nomor Batch')
@section('judul', 'Nomor Batch')
@section('halaman', 'Nomro Batch')
@section('submenu', 'Ubah Nomor Batch')
@section('container')
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
       <h3 class="text-blue h4">Form Ubah Nomor Batch</h3>
     </div>
  </div>
      <div class="dropdown-divider"></div>
      <br>
        <form method="POST" id="quickForm" action="/batch/update">
            {{ method_field('patch') }}
            @csrf  
