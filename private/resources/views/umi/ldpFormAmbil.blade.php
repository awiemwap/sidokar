@extends('deskapp.app')
@section('tittle', 'Nomor LDP 02 UMI')
@section('judul', 'Nomor LDP 02 UMI')
@section('halaman', 'Nomor LDP 02 UMI')
@section('submenu', 'Nomor Ambil LDP 02 UMI')
@section('container')
    <div class="pd-20 card-box mb-30">
      <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Ambil Nomor LDP 02 UMI</h3>
        </div>
      </div>
        <div class="dropdown-divider"></div>
        <br>
        <form method="POST" id="quickForm" action="{{ route('umildp.simpan') }}">
          @csrf  
