@extends('deskapp.app')
@section('tittle', 'TV.01 Tim KEKDA')
@section('judul', 'TV.01 Tim KEKDA')
@section('halaman', 'TV.01 Tim KEKDA')
@section('submenu', 'Ambil TV.01 Tim KEKDA')
@section('container')
    <div class="pd-20 card-box mb-30">
      <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Ambil Nomor TV.01 Tim KEKDA</h3>
        </div>
      </div>
        <div class="dropdown-divider"></div>
        <br>
        <form method="POST" id="quickForm" action="{{ route('kekdatv01.simpan') }}">
          @csrf  
