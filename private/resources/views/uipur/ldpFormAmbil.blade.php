@extends('deskapp.app')
@section('tittle', 'Nomor LDP UIPUR')
@section('judul', 'Nomor LDP UIPUR')
@section('halaman', 'Nomor LDP UIPUR')
@section('submenu', 'Nomor Ambil LDP UIPUR')
@section('container')
    <div class="pd-20 card-box mb-30">
      <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Ambil Nomor LDP UIPUR</h3>
        </div>
      </div>
        <div class="dropdown-divider"></div>
        <br>
        <form method="POST" id="quickForm" action="{{ route('uipurldp.simpan') }}">
          @csrf  
