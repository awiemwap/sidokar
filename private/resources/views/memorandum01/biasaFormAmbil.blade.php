@extends('deskapp.app')
@section('tittle', ' Ambil M01 Biasa')
@section('judul', 'Memorandum M01 Biasa')
@section('halaman', 'Memorandum M01 Biasa')
@section('submenu', 'Ambil M01 Biasa')
@section('container')
    <div class="pd-20 card-box mb-30">
      <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Ambil Nomor M.01 Biasa</h3>
        </div>
      </div>
        <div class="dropdown-divider"></div>
        <br>
        <form method="POST" id="quickForm" action="{{ route('m01biasa.simpan') }}">
          @csrf  
