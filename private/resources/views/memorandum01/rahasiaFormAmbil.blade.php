@extends('deskapp.app')
@section('tittle', ' Ambil M01 Rahasia')
@section('judul', 'Memorandum M01 Rahasia')
@section('halaman', 'Memorandum M01 Rahasia')
@section('submenu', 'Ambil M01 Rahasia')
@section('container')
    <div class="pd-20 card-box mb-30">
      <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Ambil Nomor M.01 Rahasia</h3>
        </div>
      </div>
        <div class="dropdown-divider"></div>
        <br>
        <form method="POST" id="quickForm" action="{{ route('m01rahasia.simpan') }}">
          @csrf  
