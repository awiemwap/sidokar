...
<div class="pd-20 card-box mb-30">
  <div class="clearfix">
     <div class="pull-left">
      ...
      <br>
        <form method="POST" id="quickForm" action="/m01biasa/backdatenew/store">
            {{ method_field('patch') }}
            @csrf  
            ...
            <div class="form-group">
                <label for="tujuan"><b>Satker Penerima</b></label>
                <input type="date" name="tanggal" class="form-control @error('tujuan') is-invalid @enderror" id="tujuan" value="">
            </div>
