@extends('deskapp.app')
@section('tittle', 'Nomor LDP CA')
@section('judul', 'Nomor LDP CA')
@section('halaman', 'Nomor LDP CA')
@section('submenu', 'Nomor Ambil LDP CA')
@section('container')
    <div class="pd-20 card-box mb-30">
      <div class="clearfix">
        <div class="pull-left">
          <h3 class="text-blue h4">Form Ambil Nomor LDP CA</h3>
        </div>
      </div>
        <div class="dropdown-divider"></div>
        <br>
        <form method="POST" id="quickForm" action="{{ route('caldp.simpan') }}">
          @csrf  
