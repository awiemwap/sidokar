...
class UserController extends Controller
{
    ...
    public function simpanUser(Request $request)
    {
        ...
        $request->validate([
            ...
            $files = $request->file('foto')->getClientOriginalName();
            $tujuan_upload = 'foto';
            $request->file('foto')->move($tujuan_upload, $files);
        ...
        Alert::success('Selesai', 'User berhasil ditambahkan!');
    ...
    {
        User::find($show->id)->delete();

        Alert::success('Selesai', 'User berhasil dihapus');
        return redirect('user');
    }
}
